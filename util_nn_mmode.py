...
def get_unet(numLabels=4):
    ...
    # model.compile(optimizer=Adam(learning_rate=1e-4), loss=dice_coef_loss, metrics=[dice_coef, 'accuracy'])
    # model.compile(optimizer=Adam(learning_rate=1e-4), loss=dice_coef_multilabel_loss, metrics=[dice_coef_multilabel, 'accuracy'])
